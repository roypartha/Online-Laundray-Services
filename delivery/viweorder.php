                    ...
                    <?php
                        ...
                        if ($resultCheck > 0) {
                            while ($row = mysqli_fetch_assoc($result )){
                                echo "<tr><td>".$row["order_id"]."</td><td>".$row["uname"]."</td><td>".$row["address"]."</td><td>".$row["city"]."</td><td>".$row["zip"]."</td><td>".$row["com_name"]."</td><td>".$row["branch"]."</td><td>".$row["service"]."</td><td>".$row["status"]."</td></tr>";
                            }
                            echo "</table>";
