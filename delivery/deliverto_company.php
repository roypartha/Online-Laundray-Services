            ...
            <div class="show">
                <table>
                    <tr>
                        ...
                        <th>Service</th>
                        <th>Status</th>
                        <th class ="th1">Shift</th>
                       
                       
                    </tr>
                    <?php
                        $sql = "SELECT * FROM `order_assign` WHERE (`status` = 'way to company') AND `deliver_id`='$uname'";
                        ...
                        if ($resultCheck > 0) {
                            while ($row = mysqli_fetch_assoc($result )){
                                ...
                                "</td><td>".$row["com_name"]."</td><td>".$row["branch"]."</td><td>".$row["service"]."</td><td>".$row["status"]."</td><td class ='td1' >"."<a href='deliverto_company_process.php?orderid=$row[order_id]'>SHIFT</a>"."</td></tr>";
                            }
                            echo "</table>";
