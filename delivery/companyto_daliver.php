        ...
        <div class="div_center">
            ...
            <div class="show">
                <table>
                    ...
                    <?php
                        $sql = "SELECT * FROM `order_assign_company` WHERE (`status` = 'shift request') AND `deliver_id`='$uname'";
                        ...
                        if ($resultCheck > 0) {
                            while ($row = mysqli_fetch_assoc($result )){
                                ...
                                "</td><td>".$row["com_name"]."</td><td>".$row["branch"]."</td><td>".$row["service"]."</td><td>".$row["status"]."</td><td class ='td1' >"."<a href='companyto_daliver_process.php?orderid=$row[order_id]'>Receive</a>"."</td></tr>";
                            }
                            echo "</table>";
