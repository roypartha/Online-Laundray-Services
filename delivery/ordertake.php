            ...
            <div class="show">
                <table>
                    <tr>
                        ...
                        <th>Service</th>
                        <th>Status</th>
                        <th class ="th1">Receive</th>
                        <th class ="th2">Edit</th>
                       
                    </tr>
                    <?php
                        $sql = "SELECT * FROM `order_assign` WHERE (`status` = 'shift to deliver') AND `deliver_id`='$uname'";
                        ...
                        if ($resultCheck > 0) {
                            while ($row = mysqli_fetch_assoc($result )){
                                ...
                                "</td><td>".$row["com_name"]."</td><td>".$row["branch"]."</td><td>".$row["service"]."</td><td>".$row["status"]."</td><td class ='td1' >"."<a href='takeoder_process.php?orderid=$row[order_id]'>Receive</a>"."</td><td class ='td2' >"."<a href='takeoder_process.php?orderid=$row[order_id]'>Edit & Receive</a>"."</td></tr>";
                            }
                            echo "</table>";
