...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="add_transpoter.css">
    <title>ADD EMP</title>
</head>
<body>
    <main>
    ...
    <div class="div1" >
        ...
        <h2>Registration Page For Transpoter</h2> <br>
        <h4>ID Formate :</h4> <p class ="pl">tr-XXXXX(tr-20348)</p>
         <h4>Password :</h4>
    ...
    <div class = "div2">
        ...
        <form action="transpoter_process.php" method="POST">
            <table>
                <tr>
                ...
                <!--<tr>
                    <td class ="td_all">Car licence Number</td>
                    <td><input type="text" name="car_licence" placeholder="Car licence Number"></td>
                </tr>--->
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="uname" placeholder="tr-XXXX"></td>
                </tr>
                <tr>
