...
if(isset($_POST["submit"])){
    ...
    $count=Valitation($_POST["wArea"],$count);
    ...
    if($count==11 && $count1==3){
        ...
        if(!$conn){
            ...
            $sql= "INSERT INTO pick_deliver (name,address,nid,phone,salary,Dep,etype,jDate,id,pass,depid,area) VALUES ('$name','$address','$nid','$phone','$salary','$dept','$emp_type','$jDate','$uname','$pass','$depid', '$wArea')";
