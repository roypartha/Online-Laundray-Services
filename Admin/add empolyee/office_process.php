...
if(isset($_POST["submit"])){
    ...
    $count=Valitation($_POST["bDate"],$count);
    ...
    if($count==11 && $count1==3){
        ...
        if(!$conn){
            ...
            $sql= "INSERT INTO office_emp (name,address,nid,birthdate,phone,salary,dept,etype,jDate,id,pass,depid) VALUES ('$name','$address','$nid','$bDate','$phone','$salary','$dept','$emp_type','$jDate','$uname','$pass','$depid')";
