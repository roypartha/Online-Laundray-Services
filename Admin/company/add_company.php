...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="add_com.css">
...
<body>
    ...
    <div class="div1" >
        ...
        <h2>Registration Page For Company</h2> <br>
        <h4>ID Formate :</h4>
        <p class ="pl">cp-XXXXX(cd-20348)</p>
        <h4>Password :</h4>
    ...
    <div class = "div2">
        ...
        <form action="add_company_process.php" method="POST">
            <table>
                <tr>
                    <td class ="td_all">Company Name</td>
                    <td><input type="text" name="name" placeholder="Company Name"></td>
                </tr>
                <tr>
