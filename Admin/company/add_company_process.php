...
if(isset($_POST["submit"])){
    ...
    $count=valitation($_POST['id'],$count);
    $count1=IdValitation($_POST['id'],$count1);
    ...
    if($count==6 && $count1==4){
        ...
        if(!$conn){
            ...
            $sql = "SELECT * FROM company WHERE com_id='$id' OR com_mail='$mail' OR com_name='$name'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                echo "User Name or Email is already exist"."<br>";
                header("refresh: 4 ; url = add_company.php");
            }
            else{
                $sql= "INSERT INTO company(com_name,com_mail,com_phn,com_id,com_pass,com_add_date) VALUES ('".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['id']."','".$_POST['pass']."','".$_POST['jDate']."')";
